...
# Checa conex�o com a internet (validando DNS do Google)
...
function Activate-WindowsOffice {
    try {
        ...
        Log "Ativador executado. Aguarde confirma��o do sistema."
    } catch {
...
# DOWNLOAD: OfficeSetup.exe na �rea de Trabalho � apenas download, oferece abrir instalador no fim
function Download-OfficeSetup {
    try {
        Log "Baixando instalador do Office 365 64bits PT-BR para a �rea de Trabalho..."
        ...
        Log "Download conclu�do: $file"

        # Oferece ao usu�rio instalar j� na sequ�ncia
        $result = [System.Windows.Forms.MessageBox]::Show(
            "Download do Office conclu�do!\nDeseja iniciar a instala��o agora?\n(Clique 'N�o' para instalar depois pela �rea de Trabalho)",
            "Download do Office",
        ...
        if ($result -eq [System.Windows.Forms.DialogResult]::Yes) {
            ...
            Log "Instalador do Office N�O foi iniciado. Est� dispon�vel na �rea de Trabalho."
        }
    } catch {
...
# Se��o Programas (Instala��o via Winget)
...
# Se��o Office (caixa s� para download na �rea de trabalho)
